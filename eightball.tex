...
\RuleSection{Object of the Game}{8ball:description} %\label{8ball:description}

\RuleSection{Format of Games}{8ball:format} %\label{8ball:format}
...
\RuleSection{Racking}{8ball:racking} %\label{8ball:racking}
...
\RuleSection{Breaking \& Establishment of Set}{8ball:breaking} %\label{8ball:breaking}
...
\RuleSection{General Play}{8ball:general} %\label{8ball:general}
...
\RuleSection{Fouling}{8ball:fouling} %\label{8ball:fouling}
...
\subruleitem The cue ball is hit into a ball that is not the player's own first. This does not include coloured balls being hit during the break (\ruleref{8ball:breakingballs}) or during any subsequent shots until a ball sinks (\ruleref{8ball:breakingnoballs}). Hitting the black/8-ball first remains a foul in these instances. This rule is excepted in some cases of a snooker (\ruleref{8ball:snooker}).%
...
\RuleSection{Snooker}{8ball:snooker} %\label{8ball:snooker}
...
\subruleitem If the player is on the black/8-ball, the player has the option of enacting \emph{Nomination Rule 1} (see \ruleref{8ball:nomination1}). This does not apply in the case of a self-snooker.%
...
\subruleitem In the case of a foul table snooker, the player may move the cue ball to the D. If the player remains snookered in the D, they have the option of enacting \emph{Nomination Rule 2} (see \ruleref{8ball:nomination2}).%
...
\RuleSection{Special Rules}{8ball:special} %\label{8ball:special}
...
\RuleSection{Ending The Game}{8ball:ending} %\label{8ball:ending}
...
\ruleitem If a player fouls while on the black/8-ball, the game ends, and that player loses. See \ruleref{8ball:fouling} for fouls. This applies even after the 8-ball has been sunk (e.g., the black/8-ball is sunk, but the cue ball keeps going and ends up sinking too).%
...
\ruleitem If the player breaking successfully “calls the break” (see \ruleref{8ball:callingthebreak} for “calling the break”) it is an instant win.%
...
\RuleSection{Things that feel like cheating... but aren't}{8ball:notcheating} %\label{8ball:notcheating}
...
\RuleSection{Doubles}{8ball:doubles} %\label{8ball:doubles}
...
\RuleSection{Etiquette \& Behaviour}{8ball:etiquette} %\label{8ball:etiquette}
